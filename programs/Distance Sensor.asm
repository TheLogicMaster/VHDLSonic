...
; Configure T1 in one-shot mode for 10us - sends a 10us long activation trigger
    ldr r0, 50      ;prescaler
...
echo_pulse_begins:
    ...
    beq echo_pulse_begins                                               ;keep checking P1 until it's High -> the issue with this is that if it's never high, the whole code just blocks
    str r2, [{led_0}]
...
;mod by 100 to get hundreds, then by 10, to get tens, and remaining is singles
    push r0                                                             ;save result
    ...
    pop r0
    jsr udiv                                                            ;dive by 10 to get hundreds digit
